  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-10 text-center relative">
      ...
      <div className="mb-8 relative">
        ...
        <h1 className="gradient-text text-4xl font-bold tracking-tight">QURL</h1>
      ...
      <div className="w-[320px] flex flex-col gap-2.5">
        ...
        <button
          ...
          className={[
            ...
            busy ? 'cursor-wait opacity-60' : 'cursor-pointer hover:shadow-[0_0_20px_rgba(0,153,255,0.25)]',
          ].join(' ')}
        >
